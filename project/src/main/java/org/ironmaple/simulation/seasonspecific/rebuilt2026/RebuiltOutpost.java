 ...
 *
 * <p>This class simulates an outpost on the field where fuel can be scored. It has a store of fuel
 * that can be added too by scoring in it. This fuel can then be dumped via {@link #dump()} or
...
public class RebuiltOutpost extends Goal {
   ...
   * therefore only hit about half the time. Additionally, if the outpost does not have game pieces
